...
assert_upgraded_save_import_phase_a_boundaries() {
  ...
  printf '%s\n' '{"controlModVersion":"0.3.9","loginChatPrivacyPatchAvailable":true,"hostFarmhousePreservationPatchAvailable":true,"hostAutomationBridgeAvailable":true,"hostSleepSafetyPatchAvailable":true}' >"$instance_dir/.local-container/control/options.json"
