...
const serverControlPageSource = readFileSync(new URL('../src/games/stardew/pages/ServerControlPage.tsx', import.meta.url), 'utf8')
const playerAuthDialogSource = readFileSync(new URL('../src/games/stardew/PlayerAuthSettingsDialog.tsx', import.meta.url), 'utf8')
const playerAuthDialogCss = readFileSync(new URL('../src/games/stardew/PlayerAuthSettingsDialog.css', import.meta.url), 'utf8')
...
assert.match(playerAuthDialogSource, /!role\.configured/)
