...
PANEL_HOST_INSTALL_DIR="${PANEL_HOST_INSTALL_DIR:-$INSTALL_DIR}"
...
compose_cmd() {
  docker_cmd compose --project-name "$PANEL_COMPOSE_PROJECT" --env-file "$ENV_FILE" -f "$COMPOSE_FILE" "$@"
}
...
PANEL_HOST_INSTALL_DIR=$PANEL_HOST_INSTALL_DIR
PANEL_HOST_COMPOSE_FILE=$PANEL_HOST_COMPOSE_FILE
...
services:
  panel:
    ...
    environment:
      ...
      PANEL_HOST_DATA_DIR: "${PANEL_HOST_DATA_DIR}"
      PANEL_HOST_INSTALL_DIR: "${PANEL_HOST_INSTALL_DIR}"
      PANEL_HOST_COMPOSE_FILE: "${PANEL_HOST_COMPOSE_FILE}"
      PANEL_COMPOSE_PROJECT: "${PANEL_COMPOSE_PROJECT}"
