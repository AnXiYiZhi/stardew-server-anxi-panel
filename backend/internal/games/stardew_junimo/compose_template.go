...
const junimoComposeTemplate = `services:
  ...
  server:
    ...
    environment:
      ...
      API_PORT: "8080"
      API_KEY: "${API_KEY:-}"
      SAP_PLAYER_AUTH_MODE: "${SAP_PLAYER_AUTH_MODE:-}"
      SAP_PLAYER_AUTH_REVISION: "${SAP_PLAYER_AUTH_REVISION:-}"
      SAP_ROLE_AUTH_KEY: "${SAP_ROLE_AUTH_KEY:-}"
      SAP_ROLE_PASSWORDS_B64: "${SAP_ROLE_PASSWORDS_B64:-}"
    ...
    volumes:
      ...
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/DOCKER_IMAGE_PLATFORM:/etc/cont-env.d/DOCKER_IMAGE_PLATFORM:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/GTK_A11Y:/etc/cont-env.d/GTK_A11Y:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/NO_AT_BRIDGE:/etc/cont-env.d/NO_AT_BRIDGE:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/TAKE_CONFIG_OWNERSHIP:/etc/cont-env.d/TAKE_CONFIG_OWNERSHIP:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/XDG_CACHE_HOME:/etc/cont-env.d/XDG_CACHE_HOME:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/XDG_CONFIG_HOME:/etc/cont-env.d/XDG_CONFIG_HOME:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/XDG_DATA_HOME:/etc/cont-env.d/XDG_DATA_HOME:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/XDG_RUNTIME_DIR:/etc/cont-env.d/XDG_RUNTIME_DIR:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-env/XDG_STATE_HOME:/etc/cont-env.d/XDG_STATE_HOME:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-groups/cinit/id:/etc/cont-groups.d/cinit/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-groups/nogroup/id:/etc/cont-groups.d/nogroup/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-groups/root/id:/etc/cont-groups.d/root/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-groups/shadow/id:/etc/cont-groups.d/shadow/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-groups/staff/id:/etc/cont-groups.d/staff/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/_apt/gid:/etc/cont-users.d/_apt/gid:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/_apt/home:/etc/cont-users.d/_apt/home:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/_apt/id:/etc/cont-users.d/_apt/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/root/gid:/etc/cont-users.d/root/gid:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/root/grps:/etc/cont-users.d/root/grps:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/root/home:/etc/cont-users.d/root/home:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/cont-users/root/id:/etc/cont-users.d/root/id:ro
      - ${INSTANCE_HOST_DATA_DIR}/.local-container/mods/StardewAnxiPanel.Control:/data/Mods/StardewAnxiPanel.Control
