...
当前正式版为 `v0.4.10`（commit `7d9d0e267d942952701bc14ac19d032951d2dfd7`）。本版修复低高度/窄屏确认框、Steam 二维码和新建游戏弹窗拉伸/越界，运行栈升级允许 Steam 未登录的 auth 服务按严格离线合约继续，并在 `verifying_auth` 阶段显示累计等待和“页面会自动刷新，不是卡死”。发布、升级/回滚、三仓回拉和升级后 UI 证据统一见 `docs/09-image-build.md`。
