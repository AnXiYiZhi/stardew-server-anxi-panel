...
- [x] 桌面首屏二次收紧（本地完成，未发布）：`>=960px` 的 Hero 顶/底 padding 收为 `nav + 10px / 50px`，功能卡区额外上提 12px；1700×1100 的“顶栏→品牌行”由约 72.36px 收到 48px，“加群卡→功能卡”由约 87.64px 收到 64px。390/959px 原节奏不变，960/1024/1700px 无横向溢出，959px 菜单交互正常。
