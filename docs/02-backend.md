...
- 当前嵌入 Control DLL SHA256：`465c1cf64d18d994e7f1f5d478aa834867569484e8a9f0619fb199a586f88533`。在真实 SVE 创建、重启、切档、备份恢复和故障注入验证完成后，`ENABLE_MODDED_FARM_CREATION` 已改为默认 true；显式 false 仍可关闭。
...
- 当前 DLL SHA256 仍为 `465c1cf64d18d994e7f1f5d478aa834867569484e8a9f0619fb199a586f88533`；该阶段 feature flag 默认 false，现行缺省值已由 `MOD-FARM-DEFAULT-ON-1` 改为 true。该阶段未创建 tag、未 push、未发布镜像、未修改既有实例。
